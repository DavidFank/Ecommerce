...
class LineitemsControllerTest < ActionController::TestCase
  ...
  test "should create lineitem" do
    assert_difference('Lineitem.count') do
      post :create, lineitem: { line_item_total: @lineitem.line_item_total, order_id: @lineitem.order_id, product_id: @lineitem.product_id, quantity: @lineitem.quantity }
    end
  ...
  test "should update lineitem" do
    patch :update, id: @lineitem, lineitem: { line_item_total: @lineitem.line_item_total, order_id: @lineitem.order_id, product_id: @lineitem.product_id, quantity: @lineitem.quantity }
    assert_redirected_to lineitem_path(assigns(:lineitem))
  end
